...
HIBP_API_KEY = "INSERT HIBP API KEY HERE"
...
def analyze_email_header(raw_headers):
    ...
    # Gather IPs from Received headers
    found_ips = []
    if received_lines:
...
"""
    ...
    # ---------------------------
    # Parses Authentication-Results headers to see authentication status
...
|======||=====================||===============================================
| [1]  || IP Info Search      || Retrieves IP address information
| [2]  || Deep Account Search || Retrieves profiles from various websites
| [3]  || Phone Info Search   || Retrieves phone number information
...
| [11] || Password Analyzer   || Evaluates password strength (Weak, Moderate, Strong)
|------||---------------------||-----------------------------------------------
